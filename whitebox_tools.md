...
Extracts features from an input vector into an output file based on attribute properties.
...
Derives topographic hachures from a raster surface.
...
### otsu_thresholding
Applies Ostu's method for optimal binary thresholding of a continuous image.
...
This tool resolves directional errors in digitized vector streams.
